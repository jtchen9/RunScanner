...
===============
Pi_AV_Reference_Guide:
===============
To play mp3 or wave file.
---------
mpv --ao=alsa --audio-device=alsa/default --no-video ~/music.mp3
==============================================================
To deal with initial delay
---------
espeak-ng "Front center" --stdout \
| sox -t wav - -t wav - pad 0.3 \
| mpv --ao=alsa --audio-device=alsa/default -
---------
mpv --ao=alsa --audio-device=alsa/default --no-video --quiet \
    --audio-file=/dev/zero --length=0.3
    
espeak-ng "Front center" --stdout \
| mpv --ao=alsa --audio-device=alsa/default -
==============================================================
WAV-based TTS (more explicit, easier to debug)
---------
espeak-ng -w /tmp/tts.wav "Robot is moving"

mpv --ao=alsa --audio-device=alsa/default --no-video /tmp/tts.wav
==============================================================
Another TTS software
---------
pico2wave -w /tmp/tts.wav "Front center"

mpv --ao=alsa --audio-device=alsa/default --no-video /tmp/tts.wav
==============================================================
Beep Test
---------
speaker-test -t sine -f 880 -c 1
==============================================================
